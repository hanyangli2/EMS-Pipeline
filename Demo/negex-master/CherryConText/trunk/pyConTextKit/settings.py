...
SECRET_KEY = 'gj+j^z0v=2oih+aqj79&jmcg7y_%$)!(!$bkby9%jsx#b+%h1u'
...
MIDDLEWARE_CLASSES = (
    ...
    'pyConTextKit.middleware.LoginRequiredMiddleware',
)

LOGIN_URL = '/pyConTextKit/accounts/login/'
#LOGIN_REDIRECT_URL = '/pyConTextKit/index/'
...
ROOT_URLCONF = 'pyConTextKit.urls'
...
#    'pyConTextKit.context_processors.media_url',
#}
